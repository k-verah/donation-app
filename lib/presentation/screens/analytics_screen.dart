                        ...
                        if (analyticsProv.filterStats.isEmpty)
                          const Card(
                            child: Padding(
                              ...
                              child: Center(
                                child:
                                    Text('No filter usage data available yet'),
                              ),
                            ),
                          )
                        else
                          ...analyticsProv.filterStats
                              .take(10)
                              .map((stat) => Card(
                        ...
                        if (analyticsProv.pointStats.isEmpty)
                          const Card(
                            child: Padding(
                              ...
                              child: Center(
                                child:
                                    Text('No point usage data available yet'),
                              ),
                            ),
                          )
                        else
                          ...analyticsProv.pointStats
                              .take(10)
                              .map((stat) => Card(
                                    margin: const EdgeInsets.only(bottom: 8),
                                    child: ListTile(
                                    ...
                                    Expanded(
                                      child: BarChart(
                                        BarChartData(
                                          ...
                                          maxY: analyticsProv
                                                  .filterStats.isNotEmpty
                                              ? analyticsProv.filterStats.first
                                                      .usageCount
                                                      .toDouble() *
                                                  1.2
                                              : 10,
